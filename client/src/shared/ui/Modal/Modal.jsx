...
export function Modal({ isOpen, title, description, onClose, children, wide = false }) {
  const titleId = useId();
  const descId = useId();
      ...
      >
        <header className="modal__header">
          <div className="modal__head">
            ...
            {description && <p className="modal__description" id={descId}>{description}</p>}
          </div>

          <button className="button button--icon button--ghost" type="button" aria-label="Закрыть модальное окно" onClick={onClose}>
